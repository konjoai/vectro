...
_LANGCHAIN_ERROR = (
    "langchain-core is required for VectroVectorStore. Install with: pip install langchain-core"
)
...
class VectroVectorStore:
    ...
    def similarity_search_by_vector(
        ...
        **kwargs: Any,
        ...
        return [
            doc
            for doc, _ in self.similarity_search_by_vector_with_score(embedding, k=k, filter=filter)
        ]
