...
class ProfileManager:
    ...
    def save_profiles(cls, filepath: str):
        ...
        data = {name: profile.to_dict() for name, profile in cls._custom_profiles.items()}
...
def create_custom_profile(
    ...
    return CompressionProfile(
        name=name, quantization_bits=quantization_bits, range_factor=range_factor, **defaults
    )
...
if __name__ == "__main__":
    ...
    custom_profile = create_custom_profile("my_custom", quantization_bits=6, range_factor=0.92)
